...
- feat: S3 전년 동월 비교 Chip + 추이 카드 (packet 0012)
- feat: S4 시뮬레이션 화면 — 히어로·비교 카드·구간 하락 배지 (/simulate) (packet 0013)
- feat: S4 가전 추가/편집 BottomSheet + 영속화 (packet 0014)
- feat: S5 리포트 본문 — 팁 카드 + state 가드 (/report) (packet 0015)
- feat: S5 TossRewardAd 게이트 + 24시간 열람권 (packet 0016)
- feat: S6 우리 동네 비교 — 지연 로더 + 히어로 (/region) (packet 0017)
